...
def show_main_menu(number, balance, balance_expired_at):
    ...
    print(Fore.GREEN + "="*40)
    print(Fore.CYAN + "             INFORMASI AKUN             ")   
    print(Fore.GREEN + "="*40)
    print(Fore.BLUE + f"   Nomor: {phone_number}")
    print(Fore.BLUE + f"   Pulsa: Rp {remaining_balance}")
    print(Fore.BLUE + f"   Masa aktif: {expired_at_dt}")
    print(Fore.GREEN + "="*40)
    print("")
    print(Fore.GREEN + "="*40)
    print(Fore.CYAN + "                  MENU                  ")   
    print(Fore.GREEN + "="*40)
    print(Fore.BLUE + "   1. Login/Ganti akun")
    print(Fore.BLUE + "   2. Lihat Paket Saya")
    print(Fore.BLUE + "   3. Beli Paket XUT")
    print(Fore.BLUE + "   4. Beli Paket Bebas Puas") 
    print(Fore.BLUE + "   5. Beli Paket Xtra Combo Mini")
    print(Fore.BLUE + "   6. Beli Paket Spesial For You")
    print(Fore.BLUE + "   7. Beli Paket Edukasi")
    print(Fore.BLUE + "   8. Beli Paket Xtra Combo Old")
    print(Fore.BLUE + "   9. Beli Paket Bonus XCP")
    print(Fore.BLUE + "  10. Beli Paket XCP & XCV")
    print(Fore.BLUE + "  11. Beli Paket Bonus Prepaid")
    print(Fore.BLUE + "  12. Beli Paket Hotrod Baru")
    print(Fore.BLUE + "  13. Beli Paket Pilkada Damai")
    print(Fore.BLUE + "  14. Beli Paket XL Reward")
    print(Fore.BLUE + "  15. Beli Paket Bundling")
    print(Fore.BLUE + "  16. Beli Paket XCP Gift")
    print(Fore.BLUE + "  17. Beli Paket Bonus Akrab")
    print(Fore.BLUE + "  18. Beli Paket Xtra Combo Flex")
    print(Fore.BLUE + "  19. Beli Paket Berdasarkan Family Code")
    print(Fore.BLUE + "  99. Tutup aplikasi")   
    print(Fore.GREEN + "="*40)
