...
f"[bold green] 2.[/] Cek Kuota", 
f"[bold green] 3.[/] Xtra Unlimited Turbo", 
f"[bold green] 4.[/] Bebas Puas", 
f"[bold green] 5.[/] Xtra Combo Mini", 
f"[bold green] 6.[/] Spesial For you", 
f"[bold green] 7.[/] Edukasi", 
f"[bold green] 8.[/] Xtra Combo Old",
f"[bold green] 9.[/] Bonus XCP", 
f"[bold green]10.[/] XCP & XCV", 
f"[bold green]11.[/] Bonus Prepaid", 
f"[bold green]12.[/] Hotrod Baru",
f"[bold green]13.[/] Pilkada Damai", 
f"[bold green]14.[/] XL Reward", 
f"[bold green]15.[/] Bundling", 
f"[bold green]16.[/] XCP Gift", 
f"[bold green]17.[/] Bonus Akrab", 
f"[bold green]18.[/] Xtra Combo Flex", 
f"[bold green]19.[/] Family Code", 
f"[bold green]99.[/] Tutup Aplikasi"]),
