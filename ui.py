...
def show_main_menu(number, balance, balance_expired_at):
    ...
    #menu
    menu_dor = Panel("\n".join([
f"[bright green] 1.[/] Login/Ganti akun", 
f"[bright green] 2.[/] Cek Kuota", 
f"[bright green] 3.[/] Xtra Unlimited Turbo", 
f"[bright green] 4.[/] Bebas Puas", 
f"[bright green] 5.[/] Xtra Combo Mini", 
f"[bright green] 6.[/] Spesial For you", 
f"[bright green] 7.[/] Edukasi", 
f"[bright green] 8.[/] Xtra Combo Old",
f"[bright green] 9.[/] Bonus XCP", 
f"[bright green]10.[/] XCP & XCV", 
f"[bright green]11.[/] Bonus Prepaid", 
f"[bright green]12.[/] Hotrod Baru",
f"[bright green]13.[/] Pilkada Damai", 
f"[bright green]14.[/] XL Reward", 
f"[bright green]15.[/] Bundling", 
f"[bright green]16.[/] XCP Gift", 
f"[bright green]17.[/] Bonus Akrab", 
f"[bright green]18.[/] Xtra Combo Flex", 
f"[bright green]19.[/] Family Code", 
f"[bright green]99.[/] Tutup Aplikasi"]),
