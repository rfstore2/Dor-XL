...
def show_main_menu(number, balance, balance_expired_at):
    ...
    print(" 4. Beli Paket Bebas Puas") 
    print(" 5. Beli Paket Xtra Combo Mini")
    print(" 6. Beli Paket Spesial For You")
    print(" 7. Beli Paket Edukasi")
    print(" 8. Beli Paket Xtra Combo Old")
    print(" 9. Beli Paket Bonus XCP")
    print("10. Beli Paket XCP & XCV")
    print("11. Beli Paket Bonus Prepaid")
    print("12. Beli Paket Hotrod Baru")
    print("13. Beli Paket Pilkada Damai")
    print("14. Beli Paket XL Reward")
    print("15. Beli Paket Bundling")
    print("16. Beli Paket XCP Gift")
    print("17. Beli Paket Bonus Akrab")
    print("18. Beli Paket Xtra Combo Flex")
    print("19. Beli Paket Berdasarkan Family Code")
